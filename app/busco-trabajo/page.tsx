    ...
    <main className="jobPage" style={{opacity:pageReady?1:0,visibility:pageReady?"visible":"hidden",transition:"opacity 220ms ease-out"}}>
      ...
      <aside className="mwcSidebar">
        ...
        <div className="mwcHelp">
          <strong>ⓘ Cómo funciona WorkCerca</strong>
          <p>Recorrido simple por todas las herramientas.</p>
          <button onClick={() => notify("Recorrido guiado WorkCerca.")}>Ver recorrido</button>
        </div>
      </aside>
      ...
      <style jsx>{`
        ...
        .mwcUser img{width:46px;height:46px;border-radius:50%;object-fit:cover;border:2px solid #20cbd0}
        ...
        .mwcInvite,.mwcHelp{margin-top:18px;border:1px solid #2f526f;border-radius:12px;padding:14px}
        .mwcInvite strong{color:#26d3cf}.mwcHelp strong{color:#fff}
        .mwcInvite p,.mwcHelp p{font-size:11px;line-height:1.5;color:#d4e0eb;margin:7px 0 10px}
        .mwcInvite button,.mwcHelp button{width:100%;border:1px solid #ffffff35;background:#ffffff0f;color:#fff;border-radius:8px;padding:9px 10px;font-size:9px;font-weight:800;cursor:pointer}
