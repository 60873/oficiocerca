    ...
    <main className="app">
      <style>{`
        ...
        *{box-sizing:border-box}html,body{margin:0;background:var(--bg);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--text)}
        ...
        .institutionHero{min-height:285px;border-radius:18px;overflow:hidden;position:relative;margin-bottom:13px;border:1px solid #e1e5e8;background:linear-gradient(90deg,rgba(15,31,48,.93),rgba(15,31,48,.67) 48%,rgba(15,31,48,.12)),url("https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=1800&q=88") center/cover no-repeat;box-shadow:0 16px 36px rgba(28,45,62,.13)}
        .institutionHeroContent{position:relative;z-index:2;width:min(680px,70%);padding:30px;color:#fff}.institutionEyebrow{display:inline-flex;padding:7px 10px;border:1px solid rgba(255,255,255,.28);border-radius:99px;background:rgba(17,34,52,.48);font-size:9px;font-weight:900}.institutionHero h2{font-size:31px;line-height:1.1;margin:13px 0 8px}.institutionHero p{max-width:590px;color:#e7edf2;font-size:12px;line-height:1.55;margin:0}.institutionHeroActions{display:flex;gap:8px;flex-wrap:wrap;margin-top:16px}.institutionHeroActions button{min-height:38px;border-radius:8px;padding:0 12px;font-size:9px;font-weight:900}.institutionHeroPrimary{border:0;background:#6b48d7;color:#fff}.institutionHeroSecondary{border:1px solid rgba(255,255,255,.38);background:rgba(17,34,52,.52);color:#fff}
        .institutionVisuals{display:grid;grid-template-columns:1.2fr 1fr 1fr;gap:10px;margin:10px 0}.institutionPhoto{min-height:170px;border-radius:15px;overflow:hidden;position:relative;background-size:cover;background-position:center;border:1px solid #e0e5e9}.institutionPhoto:after{content:"";position:absolute;inset:0;background:linear-gradient(180deg,transparent 28%,rgba(15,29,44,.9))}.institutionPhotoText{position:absolute;z-index:2;left:14px;right:14px;bottom:13px;color:#fff}.institutionPhotoText b{display:block;font-size:12px}.institutionPhotoText span{display:block;font-size:9px;color:#dce5ec;margin-top:4px}.photoStudents{background-image:url("https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=1000&q=85")}.photoTraining{background-image:url("https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=900&q=85")}.photoCareer{background-image:url("https://images.unsplash.com/photo-1523580846011-d3a5bc25702b?auto=format&fit=crop&w=900&q=85")}.stats{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.stat{border:1px solid var(--line);background:#fff;border-radius:13px;padding:14px;min-height:105px;box-shadow:0 8px 18px rgba(35,52,91,.05)}.statIcon{width:40px;height:40px;border-radius:50%;display:grid;place-items:center;background:#ece7ff;font-size:20px}.stat strong{display:block;font-size:27px;margin-top:7px}.stat small{color:#6b7487}.stat button,.link{border:0;background:transparent;color:var(--purple);font-size:10px;font-weight:900;padding:7px 0 0}
          ...
          {active==="panel" ? (
            <>
              <section className="institutionHero">
                <div className="institutionHeroContent">
                  <span className="institutionEyebrow">🎓 INSTITUTO TÉCNICO RECONQUISTA · INSTITUCIÓN VERIFICADA</span>
                  <h2>Formación que conecta con oportunidades reales</h2>
                  <p>Gestioná carreras, tecnicaturas, cursos, capacitaciones, inscripciones y convenios desde un espacio institucional profesional dentro de WorkCerca.</p>
                  <div className="institutionHeroActions">
                    <button className="institutionHeroPrimary" onClick={()=>setActive("publicar")}>+ Publicar propuesta</button>
                    <button className="institutionHeroSecondary" onClick={()=>go("/feria-de-carreras")}>Ver Feria de Carreras</button>
                  </div>
                </div>
              </section>
              <div className="stats">
              ...
              <section className="institutionVisuals">
                <article className="institutionPhoto photoStudents"><div className="institutionPhotoText"><b>Estudiantes y comunidad educativa</b><span>Acompañamiento, inscripción y comunicación en un mismo lugar.</span></div></article>
                <article className="institutionPhoto photoTraining"><div className="institutionPhotoText"><b>Cursos y capacitaciones</b><span>Formación vinculada a habilidades y oportunidades concretas.</span></div></article>
                <article className="institutionPhoto photoCareer"><div className="institutionPhotoText"><b>Carreras y futuro profesional</b><span>Más visibilidad para la oferta académica y conexión con Feria de Carreras.</span></div></article>
              </section>
