        ...
        <div className="companyContent">
          {!loading && !signedIn ? (
            ...
            <>
              ...
              <section className="companyServiceRule" aria-label="Condiciones del servicio WorkCerca">
                <div className="serviceRuleIcon" aria-hidden="true">24/7</div>
                <div>
                  <span className="eyebrow dark">SERVICIO WORKCERCA</span>
                  <h2>Pagás según la capacidad que necesitás. Tu venta es tuya.</h2>
                  <p>El plan se informa desde el comienzo. WorkCerca acerca tu oferta con personas interesadas; no cobra comisión sobre tus ventas.</p>
                </div>
                <div className="serviceRuleDecision">
                  <strong>Vos decidís cuándo ampliar</strong>
                  <span>Más fichas, sucursales, consultas o publicidad solamente con tu aprobación.</span>
                  <button onClick={() => go("/empresa/publicidad")}>Ver publicidad</button>
                </div>
              </section>
