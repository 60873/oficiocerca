...
export default function EmpresaPage() {
  ...
  return (
    ...
    >
        ...
        <div className="content">
          {screen==="panel" && (
            <>
              ...
              <section className="companyHeroVisual">
                <img
                  src="https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=1600"
                  alt="Equipo profesional de empresa"
                />
                <div className="companyHeroShade" />
                <div className="companyHeroInfo">
                  <span className="companyHeroEyebrow">EMPRESA · WORKCERCA</span>
                  <h2>Diseño & Comunicación SRL</h2>
                  <p>Comunicación, diseño y soluciones para empresas · Reconquista, Santa Fe</p>
                  <div className="companyHeroTags">
                    <span>✓ Empresa verificada</span>
                    <span>📍 Reconquista</span>
                    <span>💼 Servicios profesionales</span>
                  </div>
                </div>
                <button className="changeCover" onClick={() => notify("Desde Editar perfil empresa podrás cambiar esta imagen")}>
                  ✎ Cambiar imagen
                </button>
              </section>
              ...
              <section className="companyPhotoEcosystem">
                <div className="photoTitle"><div><span>EMPRESA · ECOSISTEMA WORKCERCA</span><h2>Tu empresa conectada con personas y oportunidades reales.</h2></div><button onClick={() => notify("Explorar ecosistema WorkCerca")}>Explorar →</button></div>
                <div className="companyPhotoGrid">
                  <article><img src="https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=700&q=85" alt="Equipo profesional"/><div><b>Talento y RR. HH.</b><small>Encontrá perfiles compatibles con IA</small></div></article>
                  <article><img src="https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=700&q=85" alt="Reunión empresarial"/><div><b>Negocios y proveedores</b><small>Conectá con empresas y servicios</small></div></article>
                  <article><img src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=700&q=85" alt="Capacitación profesional"/><div><b>Capacitaciones</b><small>Fortalecé las capacidades de tu equipo</small></div></article>
                  <article><img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=700&q=85" alt="Comercio y crecimiento"/><div><b>Visibilidad y crecimiento</b><small>Promociones, productos y publicidad</small></div></article>
                </div>
              </section>
      ...
      <style jsx>{`.companyPhotoEcosystem{margin:16px 0;background:#fff;border:1px solid #e0e7f0;border-radius:16px;padding:18px;box-shadow:0 9px 26px rgba(20,49,88,.045)}.photoTitle{display:flex;align-items:end;justify-content:space-between;gap:15px;margin-bottom:13px}.photoTitle span{font-size:7px;letter-spacing:.12em;color:#0b87a5;font-weight:900}.photoTitle h2{font-size:18px;margin:5px 0 0}.photoTitle button{border:0;background:transparent;color:#0872e9;font-size:8px;font-weight:900}.companyPhotoGrid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.companyPhotoGrid article{position:relative;height:150px;border-radius:12px;overflow:hidden;background:#071c36}.companyPhotoGrid img{width:100%;height:100%;object-fit:cover;display:block;transition:transform .25s ease}.companyPhotoGrid article:hover img{transform:scale(1.025)}.companyPhotoGrid article:after{content:"";position:absolute;inset:35% 0 0;background:linear-gradient(transparent,rgba(3,17,35,.9))}.companyPhotoGrid article div{position:absolute;z-index:2;left:12px;right:12px;bottom:11px;color:#fff}.companyPhotoGrid b,.companyPhotoGrid small{display:block}.companyPhotoGrid b{font-size:10px}.companyPhotoGrid small{font-size:7px;color:#dbe7f2;margin-top:4px}
        ...
        .companyHeroVisual{
          ...
          box-shadow:0 10px 28px rgba(20,49,88,.07);
          background:#0a1f3a
        }
        .companyHeroVisual>img{
          width:100%;
          height:260px;
          object-fit:cover;
          display:block
        ...
        .companyHeroShade{
          ...
          inset:0;
          background:
            linear-gradient(90deg,rgba(5,22,45,.88) 0%,rgba(5,22,45,.62) 42%,rgba(5,22,45,.22) 72%,rgba(5,22,45,.15) 100%),
            linear-gradient(180deg,transparent 55%,rgba(5,22,45,.36))
        }
        .companyHeroInfo{
          position:absolute;
          left:24px;
        ...
        .companyHeroTags span{
          border:1px solid rgba(255,255,255,.28);
          background:rgba(4,19,39,.42);
